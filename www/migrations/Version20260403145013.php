 ...
 */
final class Version20260403145013 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE licence (id INT AUTO_INCREMENT NOT NULL, nationaly VARCHAR(25) NOT NULL, country_resid VARCHAR(50) NOT NULL, phone INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, is_active TINYINT NOT NULL, user_id INT DEFAULT NULL, etat_id INT DEFAULT NULL, price_licence_id INT DEFAULT NULL, INDEX IDX_1DAAE648A76ED395 (user_id), INDEX IDX_1DAAE648D5E86FF (etat_id), INDEX IDX_1DAAE648926708CD (price_licence_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, etat_id INT DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_F5299398D5E86FF (etat_id), INDEX IDX_F5299398A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
